defmodule ElhexDelivery.PostalCode.Store do
  ...
  def get_geolocation_data(postal_code) do
    GenServer.call(:postal_code_store, {:get_geolocation_data, postal_code})
  end

  def handle_call({:get_geolocation_data, postal_code}, _from, geolocation_data) do
